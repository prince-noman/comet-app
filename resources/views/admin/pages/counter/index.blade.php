        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('counter.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label>Count Icon</label><br>
                        <button class="btn btn-sm btn-info show-icon">Select a icon</button> <br><br>
                        <input name="icon" value="{{ old('icon') }}" type="text" class="form-control select-icon-input">
                    </div>
                    <hr>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                <style>
                    .select-icon .preview-icon{ 
                        cursor: pointer;
                    }
                </style>
                <div class="row select-icon">
